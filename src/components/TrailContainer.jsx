...
const TrailContainer = () => {
    ...
    useEffect(() => {
        ...
        const createTrailImage = () => {
            ...
            imgContainer.classList.add("trail-image");
        ...
        const removeOldImages = () => {
            ...
            if (now >= oldestImage.removeTime) {
                ...
                imgToRemove.maskLayers.forEach((layer, i) => {
                    const startY = i * 10;
                    const endY = (i + 1) * 10;
                    const distanceFromMiddle = 4.5 - Math.abs(i - 4.5);
                ...
                imgToRemove.imageLayers.forEach((imageLayer) => {
                    imageLayer.style.transition = `opactiy ${config.outDuration}ms ${config.easing}`;
        ...
        const render = () => {
            ...
            // console.log("B. Render Loop Running. Distance:", distance);
            ...
            // console.log("C. Creating Image! Distance:", distance);
        ...
        const startAnimation = () => {
            ...
            lastMousePosRef.current = { ...mousePosRef.current };
            // console.log("A. Animation Started, Mouse Listener Active.");
            animationStateRef.current = requestAnimationFrame(render);
